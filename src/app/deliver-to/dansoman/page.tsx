...
export const metadata: Metadata = {
  title: "Same-Day Delivery in Dansoman, Accra | Mckot",
  description:
    "Same-day delivery in Dansoman, Weija, Kwashieman, and Mamprobi. Mckot covers west Accra seven days a week. Cash-on-delivery handled. From GHS 35.",
  alternates: { canonical: `${siteConfig.url}/deliver-to/dansoman` },
};

const neighborhoods = ["Dansoman", "Weija", "Kwashieman", "Mamprobi", "Darkuman", "Kaneshie"];
const crossZones = ["Accra Central", "Osu", "East Legon", "Spintex", "Tema"];

export default function DansomanPage() {
  const localSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Same-Day Delivery in Dansoman",
    description: "Same-day motorcycle delivery in Dansoman, Weija, Kwashieman, and Mamprobi. Mckot covers west Accra every day of the week. From GHS 35.",
    provider: { "@type": "LocalBusiness", name: siteConfig.name, url: siteConfig.url, telephone: siteConfig.phones.primary },
    areaServed: { "@type": "Place", name: "Dansoman, Accra, Ghana" },
      ...
      <Section className="pt-12 md:pt-16">
        <FadeIn>
          ...
          <h1 className="mt-4 text-4xl font-bold text-brand-foreground md:text-5xl">
            Same-day delivery in Dansoman and west Accra
          </h1>
          <p className="mt-6 max-w-2xl text-lg text-brand-foreground/70">
            Mckot covers Dansoman, Weija, Kwashieman, and the surrounding west Accra
            areas. Book a pickup and your parcel moves the same day, every day of the week.
          </p>
      ...
      <Section className="bg-brand-muted/10">
        <FadeIn>
          <div className="grid gap-8 md:grid-cols-2">
            <div>
              <h2 className="text-xl font-bold text-brand-foreground">West Accra areas covered</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-brand-foreground">Routes from Dansoman</h2>
              <p className="mt-2 text-sm text-brand-foreground/65">Cross-zone deliveries from Dansoman at GHS 50.</p>
