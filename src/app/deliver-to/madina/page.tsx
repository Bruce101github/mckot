...
export const metadata: Metadata = {
  title: "Same-Day Delivery in Madina, Accra | Mckot",
  description:
    "Same-day delivery in Madina, Adenta, Oyibi, and surrounding areas. Mckot covers the Madina corridor in Accra every day. Cash-on-delivery included. From GHS 35.",
  alternates: { canonical: `${siteConfig.url}/deliver-to/madina` },
};

const neighborhoods = ["Madina", "Adenta", "Oyibi", "Abokobi", "Agbogba", "Frafraha"];
const crossZones = ["East Legon", "Spintex", "Tema", "Accra Central", "Osu"];

export default function MadinaPage() {
  const localSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Same-Day Delivery in Madina",
    description: "Same-day motorcycle delivery in Madina, Adenta, Oyibi, and surrounding areas in Accra. From GHS 35.",
    provider: { "@type": "LocalBusiness", name: siteConfig.name, url: siteConfig.url, telephone: siteConfig.phones.primary },
    areaServed: { "@type": "Place", name: "Madina, Accra, Ghana" },
      ...
      <Section className="pt-12 md:pt-16">
        <FadeIn>
          ...
          <h1 className="mt-4 text-4xl font-bold text-brand-foreground md:text-5xl">
            Same-day delivery in Madina and Adenta
          </h1>
          <p className="mt-6 max-w-2xl text-lg text-brand-foreground/70">
            Mckot covers Madina, Adenta, and the Oyibi corridor. Same-day pickup and
            delivery, cash-on-delivery handled, seven days a week.
          </p>
      ...
      <Section className="bg-brand-muted/10">
        <FadeIn>
          <div className="grid gap-8 md:grid-cols-2">
            <div>
              <h2 className="text-xl font-bold text-brand-foreground">Areas covered</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-brand-foreground">Routes from Madina</h2>
              <p className="mt-2 text-sm text-brand-foreground/65">Cross-zone deliveries from Madina at GHS 50.</p>
